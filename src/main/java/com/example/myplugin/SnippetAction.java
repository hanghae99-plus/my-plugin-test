...
public class SnippetAction extends AnAction {
    ...
    public void actionPerformed(AnActionEvent e) {
        ...
        // snippetMap이 null이거나 선택한 텍스트가 스니펫 맵의 키에 해당하지 않는 경우 "invalid snippet"으로 대체
    ...
    private void replaceSelectedText(Editor editor, String text) {
        ...
        // WriteCommandAction을 사용하여 문서에 텍스트 삽입
...
//    //gradle dependency
//    // JUnit 테스트 관련 의존성
//    snippetMap.put("#junit", "testImplementation 'org.springframework.boot:spring-boot-starter-test'");
//
//    // 로그 관련 의존성
//    snippetMap.put("#log", "implementation 'org.springframework.boot:spring-boot-starter-logging'");
//
//    // JPA 의존성
//    snippetMap.put("#jpa", "implementation 'org.springframework.boot:spring-boot-starter-data-jpa'");
//
//    // 데이터베이스 의존성 (예시: H2)
//    snippetMap.put("#h2", "runtimeOnly 'com.h2database:h2'");
//
//    // Validation 의존성
//    snippetMap.put("#valid", "implementation 'org.springframework.boot:spring-boot-starter-validation'");
//
//    // Jackson JSON 처리 의존성
//    snippetMap.put("#jackson", "implementation 'com.fasterxml.jackson.core:jackson-databind'");
//
//    // Lombok 의존성
//    snippetMap.put("#lombok", "compileOnly 'org.projectlombok:lombok'\nannotationProcessor 'org.projectlombok:lombok'");
//
//    // Spring Actuator 의존성
//    snippetMap.put("#health", "implementation 'org.springframework.boot:spring-boot-starter-actuator'");
//
//    // Cache 의존성
//    snippetMap.put("#cache", "implementation 'org.springframework.boot:spring-boot-starter-cache'");
//}
